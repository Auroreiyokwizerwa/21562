...
DefaultComboBoxModel dmc=null;
    ...
    private void AddClientBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddClientBtnActionPerformed
        ...
        c.setCat(ClientCategory.STUDENT.getCategory().toString());
        }else if(CatCombo.getSelectedItem().toString().equalsIgnoreCase("staff")){
          c.setCat(ClientCategory.STAFF.getCategory().toString());
        }else{
        
        c.setCat(ClientCategory.EXTERNAL.getCategory().toString());
        }
        c.setPhoto(f);
